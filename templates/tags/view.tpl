		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="action-box">
					<a href="{$smarty.const.BASE_URL}/admin/tags/" class="btn btn-primary pull-left">
						Back to list
					</a>
					<a href="#" class="btn btn-default" title="Delete" data-target="#delete-modal" data-toggle="modal">
						<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
					</a>
					<a href="{$smarty.const.BASE_URL}/admin/tags/edit/{$id}" class="btn btn-primary" title="Edit">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Are you sure you want to remove tag no <strong>{$id}</strong>?
				</p>
			</div>
...
<script src="{$smarty.const.BASE_URL}/assets/js/tags.js"></script>
