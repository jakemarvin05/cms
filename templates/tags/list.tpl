					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="list-navbar-collapse">
							<form id="sort" class="navbar-form navbar-left">
								<div class="form-group">
									<select id="sort-field" name="sort-col" class="form-control">
										...
										<option value="update_date">Sort by update date</option>
							...
							<form id="search" class="navbar-form navbar-right" role="search">
								...
								<div class="form-group">
									<a href="{$smarty.const.BASE_URL}/admin/tags/add/" class="btn btn-primary" title="Add new account">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Are you sure you want to remove tag no <strong class="replace"></strong>?
				</p>
			</div>
