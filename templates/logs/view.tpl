		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="action-box">
					<a href="{$smarty.const.BASE_URL}/admin/logs/" class="btn btn-primary pull-left">
						Back to list
					</a>
					<a href="#" class="btn btn-default" title="Delete" data-target="#delete-modal" data-toggle="modal">
						<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
					</a>
					<a href="{$smarty.const.BASE_URL}/admin/logs/edit/{$id}" class="btn btn-primary" title="Edit">
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				...
				<table class="table">
					...
					<tr>
						<td>Message</td>
						<td><strong>Sam dziś wraca :X</strong></td>
					</tr>
				</table>
			</div>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Are you sure you want to remove log no <strong>{$id}</strong>?
				</p>
			</div>
