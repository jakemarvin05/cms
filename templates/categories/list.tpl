					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="list-navbar-collapse">
							...
							<form id="search" class="navbar-form navbar-right" role="search">
								...
								<div class="form-group">
									<a href="{$smarty.const.BASE_URL}/admin/categories/add/" class="btn btn-primary" title="Add new account">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Are you sure you want to remove category no <strong class="replace"></strong>?
				</p>
			</div>
