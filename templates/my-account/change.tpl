{include file="../header.tpl" title='My account - Change password' authorized=true current='my-account'}
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="well">
					<form class="form-horizontal" id="change-password" novalidate>
						<fieldset>
							<legend>Change password for my account</legend>
							<div class="form-group">
								<label for="change-password-old-password" class="col-lg-5 control-label">
									Old password
								</label>
								<div class="col-lg-7">
									<input class="form-control" id="change-password-old-password" name="old-password" placeholder="Old password" type="password" required>
									<span class="error-message">Old password is required</span>
								</div>
							</div>
							<div class="form-group">
