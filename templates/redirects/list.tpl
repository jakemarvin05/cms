					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="list-navbar-collapse">
							<form id="sort" class="navbar-form navbar-left">
								<div class="form-group">
									<select id="sort-field" name="sort-col" class="form-control">
										...
										<option value="name">Sort by Url</option>
										<option value="author">Sort by Page name</option>
							...
							<form id="search" class="navbar-form navbar-right" role="search">
								...
								<div class="form-group">
									<a href="{$smarty.const.BASE_URL}/admin/redirects/add/" class="btn btn-primary" title="Add new account">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Are you sure you want to remove redirect no <strong class="replace"></strong>?
				</p>
			</div>
